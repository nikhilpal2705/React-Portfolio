export const skillsData = {
    ...
    skillsRight: [
        ...
        { name: "Node", level: 90, class: "devicon-nodejs-plain-wordmark colored" },
        { name: "MySQL", level: 90, class: "devicon-mysql-original colored" },
        { name: "MongoDB", level: 80, class: "devicon-mongodb-plain colored" },
